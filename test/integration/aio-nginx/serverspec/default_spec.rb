...
describe 'configures our application' do
  describe file('/etc/nginx/sites-available/example.com-80') do
    it { should be_file }
  end
  describe file('/etc/nginx/sites-enabled/example.com-80') do
    it { should be_linked_to '/etc/nginx/sites-available/example.com-80' }
  end
