...
default['phpstack']['demo']['apache']['sites'][port1][site1]['errorlog']       = "#{node['apache']['log_dir']}/#{site1}-#{port1}-error.log"
default['phpstack']['demo']['apache']['sites'][port1][site1]['customlog']      = "#{node['apache']['log_dir']}/#{site1}-#{port1}-access.log combined"
...
default['phpstack']['demo']['apache']['sites'][port2][site1]['errorlog']       = "#{node['apache']['log_dir']}/#{site1}-#{port2}-error.log"
default['phpstack']['demo']['apache']['sites'][port2][site1]['customlog']      = "#{node['apache']['log_dir']}/#{site1}-#{port2}-access.log combined"
...
default['phpstack']['demo']['apache']['sites'][port1][site2]['errorlog']       = "#{node['apache']['log_dir']}/#{site2}-#{port1}-error.log"
default['phpstack']['demo']['apache']['sites'][port1][site2]['customlog']      = "#{node['apache']['log_dir']}/#{site2}-#{port1}-access.log combined"
...
default['phpstack']['demo']['apache']['sites'][port2][site2]['errorlog']       = "#{node['apache']['log_dir']}/#{site2}-#{port2}-error.log"
default['phpstack']['demo']['apache']['sites'][port2][site2]['customlog']      = "#{node['apache']['log_dir']}/#{site2}-#{port2}-access.log combined"
...
default['phpstack']['demo']['nginx']['sites'][port1][site1]['errorlog']       = "#{node['nginx']['log_dir']}/#{site1}-#{port1}-error.log info"
default['phpstack']['demo']['nginx']['sites'][port1][site1]['customlog']      = "#{node['nginx']['log_dir']}/#{site1}-#{port1}-access.log combined"
...
default['phpstack']['demo']['nginx']['sites'][port2][site1]['errorlog']       = "#{node['nginx']['log_dir']}/#{site1}-#{port2}-error.log info"
default['phpstack']['demo']['nginx']['sites'][port2][site1]['customlog']      = "#{node['nginx']['log_dir']}/#{site1}-#{port2}-access.log combined"
...
default['phpstack']['demo']['nginx']['sites'][port1][site2]['errorlog']       = "#{node['nginx']['log_dir']}/#{site2}-#{port1}-error.log info"
default['phpstack']['demo']['nginx']['sites'][port1][site2]['customlog']      = "#{node['nginx']['log_dir']}/#{site2}-#{port1}-access.log combined"
...
default['phpstack']['demo']['nginx']['sites'][port2][site2]['errorlog']       = "#{node['nginx']['log_dir']}/#{site2}-#{port2}-error.log info"
default['phpstack']['demo']['nginx']['sites'][port2][site2]['customlog']      = "#{node['nginx']['log_dir']}/#{site2}-#{port2}-access.log combined"
